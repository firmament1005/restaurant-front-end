...
const CastDetail: React.FC = () => {
    const [maxDate, setMaxDate] = useState(getMaxDate({ Year: new Date().getFullYear(), Month: new Date().getMonth() + 1 }));
    return (
                        ...
                        <div className='flex flex-row'>
                            <div className="bg-gray-50 relative pr-1 border border-gray-300 rounded-lg flex flex-row dark:bg-gray-700 w-auto" >
                                ...
                                <div className='flex flex-row'>
                                    ...
                                    <select className="focus:outline-none border-0 text-sm p-2.5 dark:bg-gray-700 dark:text-white">
                            ...
                            <button className='text-white dark:bg-green-700 ml-3 px-5 rounded-lg border border-gray-300'>タグ</button>
                        </div>
                    </div>
                </div>
            </div>

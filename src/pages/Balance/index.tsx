...
const Balance: React.FC = () => {
    ...
    return (
        <div className="relative w-full h-full overflow-y-auto lg:ml-64 bg-gray-900 p-4">
            <div className="w-full mb-1">
                <div className="mb-4">
                    <nav className="flex mb-5" aria-label="Breadcrumb">
                        <ol className="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                            <li className="inline-flex items-center">
                                <Link to="/home/balance" className="inline-flex items-center text-gray-700 hover:text-primary-600 text-gray-300 hover:text-white">
                            ...
                            <li>
                                <div className="flex items-center">
                                    ...
                                    <Link to="/home/salesitem" className="ml-1 hover:text-primary-600 md:ml-2 dark:text-sky-500 dark:hover:text-white">
                                        売上商品集計
                                    </Link>
                                </div>
                            </li>
                    ...
                    <div className='flex flex-row justify-between'>
                        <h1 className="text-xl font-semibold sm:text-2xl text-white"> 収支</h1>
                        <div className='flex flex-row'>
                            <div className="bg-gray-50 relative pr-1 border border-gray-300 rounded-lg flex flex-row bg-gray-700">
